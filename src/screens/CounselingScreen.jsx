      ...
      {loading ? (
        ...
        <div className="py-auto px-4 mx-auto py-16 text-center lg:py-20 lg:px-12">
          ...
          <p>
            ...
            you will find resources and tools to help you develop skills to
            manage your mental health and wellbeing. We understand that seeking
            ...
            resources that you can use at your own pace and comfort. Our aim is
            to empower you with the tools and information you need to support
            your mental health.
          </p>
